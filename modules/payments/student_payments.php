...
// Requête de base
$query = "SELECT sp.*, s.first_name, s.last_name, s.registration_number 
...
if (!empty($start_date)) {
    $query .= " AND sp.payment_date >= :start_date";
}
if (!empty($end_date)) {
    $query .= " AND sp.payment_date <= :end_date";
}
    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header bg-warning text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0">دفعات المتعلمين</h5>
                <a href="<?php echo APP_URL; ?>/modules/payments/add_payment.php" class="btn btn-light btn-sm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <select name="status" class="form-select">
                                ...
                                <option value="refunded" <?php echo ($status == 'refunded') ? 'selected' : ''; ?>>مسترجع</option>
                            </select>
                        </div>
                        <div class="col-md-2">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                confirmDeleteBtn.href = `<?php echo APP_URL; ?>/modules/payments/delete_payment.php?id=${paymentId}`;
            });
        });
    });
</script>
